...
export function createMockArtworkResult(catalogGame = null) {
  if (catalogGame) {
    return {
...
export function createMockStorefrontMetadata({ title, storefront, catalogGame }) {
  if (catalogGame) {
    return {
  ...
  return {
    ...
    description: `This manual ${storefront} entry is in Checkpoint. Replace this mock metadata by wiring real storefront APIs into services/storefronts.js.`,
    steamGridSlug: ""
  };
}
