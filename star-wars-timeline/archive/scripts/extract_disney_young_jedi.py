...
ENTITY_URL = "https://www.disneyplus.com/browse/entity-faa35b37-3287-4a7c-9d42-a3a5f9ad9185"
TARGET_ENTRY_IDS = {
    "the-high-republic__young-jedi-adventures__show__232-bby",
}
...
def main():
    print("Extracting Disney+ play URLs for Young Jedi Adventures...", file=sys.stderr)
